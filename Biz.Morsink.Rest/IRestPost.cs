...
namespace Biz.Morsink.Rest
{
    ...
    /// <typeparam name="E">The resource type.</typeparam>
    ...
    public interface IRestPost<T, P, E, R> : IRestCapability<T>
    {
        ...
        /// <param name="resource">The resource to post to the resource.</param>
        /// <returns>A response potentially containing a typed result.</returns>
        ValueTask<RestResponse<R>> Post(IIdentity<T> target, P parameters, E resource, CancellationToken cancellationToken);
    }
}
